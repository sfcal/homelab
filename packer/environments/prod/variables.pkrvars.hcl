...
storage_pool         = "local-lvm" // Or maybe a different pool for prod, e.g., "ceph-ssd"
storage_pool_type    = "lvm"       // Or "rbd" if using Ceph
network_bridge       = "vmbr0"
qemu_agent           = true
scsi_controller      = "virtio-scsi-pci"

// ISO Settings (Using Ubuntu 24.04 as an example)
iso_file             = "local:iso/ubuntu-24.04.2-live-server-amd64.iso" // Preferred: Use local ISO if available
...
iso_storage_pool     = "local" // Storage pool where ISO resides or will be downloaded to
...
// Cloud-Init Settings
cloud_init_storage_pool = "local-lvm" // Or maybe a different pool for prod
